...
public class Calculator extends JDialog implements ActionListener , KeyListener {  
    ...
    public Calculator(JTextField jtf1) {  
    	super( (JFrame)SwingUtilities.getAncestorOfClass(JFrame.class, jtf1) , "计算器", true);
    	this.jtf = jtf1;
        // 初始化计算器  
        init();  
        // 设置计算器的背景颜色  
    ...
    private void init() {  
        ...
        // 用网格布局管理器，1行，1列的网格，网格之间的水平方向间隔为3个象素，垂直方向间隔为3个象素  
    ...
    private void returnAction(){
    	if(jtf==null){JOptionPane.showMessageDialog(null, "请先选择计算器要输入数据的空", "失败", JOptionPane.ERROR_MESSAGE); return ;}
